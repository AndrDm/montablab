...
| Повторный клик по активному | Возврат в предыдущее окно |
| Двойной клик по заголовку | Свернуть/развернуть превью в полоску |
| Клик по ✕ в заголовке | Закрыть приложение |
| Колесо мыши | Прокрутка ленты |
| Наведение на превью (~0,35 с) | Временная лупа ×3, движение мыши панорамирует; уход с превью — возврат |
